    ...
    <section className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-600 text-white py-24 md:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
          <a href="/register" className="btn px-8 py-4 text-xl font-bold bg-gradient-to-r from-orange-500 to-red-500 text-white border-none shadow-xl hover:shadow-2xl hover:from-orange-600 hover:to-red-600 transform hover:scale-110 transition-all duration-300 rounded-2xl">
            Get Started Free 🚀
          </a>
